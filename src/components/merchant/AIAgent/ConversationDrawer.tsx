...
import { XIcon, Bot, Star, Plus, Send, CheckCircle2, Clock, Search, Package, ShoppingCart, CreditCard, Link2, Truck, FileCheck, MapPin, Phone, User, Sparkles } from "lucide-react"
  ...
  return (
    <Drawer open={open} onOpenChange={(o) => !o && onClose()}>
      <DrawerContent className="p-6">
        <DrawerHeader>
          <DrawerTitle className="text-lg font-heading font-medium tracking-tight">Agent Conversation</DrawerTitle>
        ...
        <div className="mt-6 space-y-4">
          ...
          <Tabs defaultValue="conversation" className="flex flex-1 min-h-0 flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <TabsContent value="conversation" className="m-0 px-4 py-4 space-y-4">
              ...
              <TabsContent value="order" className="m-0 px-4 py-4 space-y-4">
                <Card className="rounded-xl bg-card overflow-hidden">
                  <div className="px-3 py-3 flex items-center gap-2 border-b">
                    <img src={PRODUCTS[0].img} alt={PRODUCTS[0].name} className="size-10 rounded-lg object-cover" />
          ...
          <div className="mt-4 flex gap-2 border-t border-border/60 pt-4">
            ...
            <Button size="sm" className="flex-1 rounded-full text-xs">Take Over</Button>
          </div>
        </div>
      </DrawerContent>
    </Drawer>
