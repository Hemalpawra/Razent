...
export default function ProductDrawer({ open, onClose, product }: ProductDrawerProps) {
  ...
  if (isMobile) {
    return null // Mobile handling happens in ProductsScreen
  }
  ...
  return (
    <Drawer open={open} onOpenChange={(o) => !o && onClose()}>
      <DrawerContent className="p-6">
        <DrawerHeader>
          <DrawerTitle className="text-lg font-heading font-medium tracking-tight">Product Details</DrawerTitle>
        ...
        <div className="mt-6">
          ...
          <div className="flex items-start justify-between gap-3 border-b border-border/60 pb-4">
            <div className="flex gap-3 min-w-0">
              <img src={product.image_url} alt={product.title} className="size-10 rounded-lg object-cover ring-1 ring-border/50 shrink-0" />
            ...
            <Tabs defaultValue="overview" className="w-full">
              <div className="sticky top-0 z-10 bg-popover border-b px-4">
                <TabsList className="w-full justify-start rounded-none border-0 bg-transparent p-0 h-auto gap-4">
                  ...
                  <TabsTrigger value="ai" className="rounded-none border-b-2 border-transparent bg-transparent px-0 py-2 text-sm font-medium shadow-none data-[selected]:border-primary data-[selected]:text-foreground data-[selected]:shadow-none aria-[selected=true]:border-primary aria-[selected=true]:text-foreground text-muted-foreground">
                    AI & Visibility
                  </TabsTrigger>
                  <TabsTrigger value="activity" className="rounded-none border-b-2 border-transparent bg-transparent px-0 py-2 text-sm font-medium shadow-none data-[selected]:border-primary data-[selected]:text-foreground data-[selected]:shadow-none aria-[selected=true]:border-primary aria-[selected=true]:text-foreground text-muted-foreground">
                    Activity
                  </TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="overview" className="mt-0 space-y-6 p-4">
                <Card className="rounded-xl bg-card shadow-none">
                  ...
                  <CardContent className="grid grid-cols-2 gap-3 text-xs">
                    <div className="space-y-1"><div className="text-muted-foreground">Product name</div><div className="text-sm font-medium">{product.title}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">SKU</div><div className="font-mono text-xs">{sku}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Category</div><div className="text-xs">{product.category}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Brand</div><div className="text-xs">{brand}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Product type</div><div className="text-xs">Physical · Shippable</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Status</div><Badge variant={badge.variant} className="rounded-full text-[11px] capitalize">{badge.label}</Badge></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Visibility</div><div className="text-xs">Visible to customers</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Created</div><div className="text-xs">{new Date(product.created_at).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })}</div></div>
                  </CardContent>
                </Card>
              ...
              <TabsContent value="inventory" className="mt-0 space-y-6 p-4">
                <Card className="rounded-xl bg-card shadow-none">
                  ...
                  <CardContent className="grid grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="col-span-2 flex items-center gap-2 pt-1"><Badge variant={badge.variant} className="rounded-full text-[11px]">{badge.label}</Badge><span className="text-muted-foreground">SKU {sku}</span></div>
                  </CardContent>
                </Card>
                ...
                <Card className="rounded-xl bg-card shadow-none">
                  ...
                  <CardContent className="grid grid-cols-2 gap-3 text-xs">
                    <div className="space-y-1"><div className="text-muted-foreground">Shipping weight</div><div className="text-sm">{weight}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Package size</div><div className="text-sm">{size}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">Warehouse</div><div className="text-sm">{warehouse}</div></div>
                    <div className="space-y-1"><div className="text-muted-foreground">HSN</div><div className="text-sm">8421.39.00</div></div>
                  </CardContent>
                </Card>
              </TabsContent>
                  ...
                  <CardContent className="grid grid-cols-2 gap-3">
                    <div className="rounded-lg border bg-card p-3">
                      <div className="flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground">
                        <span className="flex size-6 items-center justify-center rounded-md bg-primary/10 text-primary"><EyeIcon className="size-3.5" /></span>
                        Views from AI
                        <div className="mt-2 text-lg font-semibold leading-none text-foreground">${42 + (hash % 18)}</div>
                        <div className="mt-1 text-[11px] text-muted-foreground">Impressions</div>
                      </div>
                    </div>
                    <div className="rounded-lg border bg-card p-3">
                      <div className="flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground">
                        <span className="flex size-6 items-center justify-center rounded-md bg-primary/10 text-primary"><ShoppingCartIcon className="size-3.5" /></span>
                        Adds to cart
                        <div className="mt-2 text-lg font-semibold leading-none text-foreground">${11 + (hash % 7)}</div>
                        <div className="mt-1 text-[11px] text-muted-foreground">From AI</div>
                      </div>
                    </div>
                    <div className="rounded-lg border bg-card p-3">
                      <div className="flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground">
                        <span className="flex size-6 items-center justify-center rounded-md bg-primary/10 text-primary"><TrendingUpIcon className="size-3.5" /></span>
                        Orders from AI
                        <div className="mt-2 text-lg font-semibold leading-none text-foreground">${formatPrice(product.price_paise * (2 + (hash % 3)))}</div>
                        <div className="mt-1 text-[11px] text-lg font-semibold leading-none text-foreground">${(4 + (hash % 5))}</div>
                        <div className="mt-1 text-[11px] text-muted-foreground">AI → order</div>
                      </div>
                    </div>
                    <div className="rounded-lg border bg-card p-3">
                      <div className="flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground">
                        <span className="flex size-6 items-center justify-center rounded-md bg-primary/10 text-primary"><TrendingUpIcon className="size-3.5" /></span>
                        Conversion
                        <div className="mt-2 text-lg font-semibold leading-none text-foreground">${(8 + (hash % 9)).toFixed(1)}%</div>
                        <div className="mt-1 text-[11px] text-muted-foreground">AI → order</div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <TabsContent value="activity" className="mt-0 p-4">
                <Card className="rounded-xl bg-card shadow-none">
                  <CardHeader className="pb-2 flex flex-row items-center justify-between space-y-0">
                    ...
                    <Button variant="outline" size="sm" className="h-6 rounded-lg bg-card text-xs">View audit trail</Button>
                  </CardHeader>
                  <CardContent className="p-0">
